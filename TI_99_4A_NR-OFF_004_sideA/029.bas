  ...
  163 DISPLAY AT ( 22 , 4 )  : "ANZAHL LEBEN:1" 
  164 ACCEPT AT ( 22 , 17 ) SIZE ( - 2 ) BEEP VALIDATE ( DIGIT )  : LE1 
  170 DIM PU ( 2 ) , LE ( 2 )  :: PU ( 1 ) , PU ( 2 ) = 0  :: LE ( 1 ) , LE ( SPIELER ) = LE1 
  ...
  290 [ = 1 
  300 REM  PITFALL
  310 IF LE ( [ ) > = 1 THEN 400
  320 IF LE ( 1 ) < 1 AND LE ( 2 ) < 1 THEN CALL CLEAR  :: STOP ELSE 5000
  400 GOSUB 9000
  ...
  920 CALL DELSPRITE ( ALL )  :: CALL CLEAR 
  930 LE ( [ ) = LE ( [ ) - 1 
  940 GOTO 5000
 ...
 9812 A$ = STR$ ( LE ( 1 ) )  :: DISPLAY AT ( 3 , 4 ) SIZE ( LEN ( A$ ) )  : A$ 
 9813 IF SPIELER = 1 THEN 9820
 9815 A$ = "2:" & STR$ ( PU ( 2 ) )  :: DISPLAY AT ( 2 , 21 ) SIZE ( LEN ( A$ ) )  : A$ 
 9817 A$ = STR$ ( LE ( 2 ) )  :: DISPLAY AT ( 3 , 23 ) SIZE ( LEN ( A$ ) )  : A$ 
 9820 RETURN 
