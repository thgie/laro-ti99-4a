   10 RANDOMIZE  :: CALL CLEAR  :: Z$ = ""  :: OPTION BASE 1  :: DIM G ( 8 , 8 ) , C ( 9 , 2 ) , K ( 3 , 3 ) , N ( 3 ) , Z ( 8 , 8 ) , D ( 8 ) 
  370 T , T0 = INT ( RND * 20 + 20 ) * 100  :: T9 = 25 + INT ( RND * 10 )  :: D0 = 0  :: E , E0 = 3000  :: S9 = 200  :: S , B9 , K9 = 0  :: X$ = ""  :: X0$ = " IST" 
  470 DEF FND ( D ) = SQR ( ( K ( I , 1 ) - S1 ) ^ 2 + ( K ( I , 2 ) - S2 ) ^ 2 ) 
  475 DEF FNR ( R ) = INT ( RND * 7.98 + 1.01 ) 
 ...
 1300 I = RND  :: CALL KEY ( 0 , @ , [ )  :: IF [ = 0 THEN 1300
 ...
 2160 NEXT I  :: PRINT "UNGUELTIGER BEFEHL."  :: GOTO 1990
 ...
 3030 GOSUB 8790 :: PRINT G2$  ; " ZUSTAND VERBESSERT"  :  : 
 ...
 4700 PRINT "ALLE PHOTONENTORPEDOS       VERBRAUCHT."  :: GOTO 1990
 ...
 6010 IF D0 < > 0 THEN PRINT "SCHILDE DER STATION SCHUET- ZEN DIE ENTERPRISE"  :: RETURN 
 ...
 6330 INPUT "SOLL ER VORKOMMEN UND JAWOHLEINGEBEN:"  : A$  :: IF A$ = "JAWOHL" THEN 10
 6360 STOP 
 ...
 6770 O1$ = RPT$ ( "-" , 24 )  :: PRINT O1$  :: FOR I = 0 TO 7 
 6820 PRINT SEG$ ( Q$ , I * 24 + 1 , 24 )  :: NEXT I  :: PRINT O1$ 
 ...
 7630 FOR J = 1 TO 8  :: IF Z ( I , J ) = 0 THEN PRINT "***"  ;  :: GOTO 7720
 7700 PRINT SEG$ ( STR$ ( Z ( I , J ) + 1000 ) , 2 , 3 )  ; 
 7720 NEXT J  :: GOTO 7850
 7850 PRINT  : O1$  :: NEXT I  :: PRINT  :: GOTO 1990
 8590 R1 , Z1 = FNR ( 1 )  :: R2 , Z2 = FNR ( 2 )  :: A$ = "   "  :: GOSUB 8830 :: IF Z3 = 0 THEN 8590
 8600 RETURN 
 ...
 8700 Q$ = SEG$ ( Q$ , 1 , S8 - 1 ) & A$ & SEG$ ( Q$ , LEN ( Q$ ) - 188 + S8 , 189 - S8 )  :: RETURN 
 8790 ON R1 GOTO 8792, 8794, 8796, 8798, 8800, 8802, 8804, 8806
 8792 G2$ = "RICHTUNGSMOTOREN"  :: RETURN 
 8794 G2$ = "NAHBEREICHSFUEHLER"  :: RETURN 
 8796 G2$ = "FERNBEREICHSFUEHLER"  :: RETURN 
 8798 G2$ = "PHASER-KONTROLLE"  :: RETURN 
 8800 G2$ = "PHOTONEN ROEHREN"  :: RETURN 
 8802 G2$ = "ZERSTOERUNGSKONTR."  :: RETURN 
