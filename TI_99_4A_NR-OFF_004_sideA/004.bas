   ...
   11 IF X > 3 THEN 10
   20 INPUT "VERTIKAL?:"  : Y 
   21 INPUT "ZENTRIERT?:"  : L$ 
   22 G1 = 0  :: IF L$ > "P" THEN G1 = 1 
   23 INPUT "ZEICHEN(TIPPE 'ALLE', WENN  ZEICHEN AUSGEDRUCKT WERDEN  SOLLEN)"  : M$ 
   29 PRINT "TEXT"  ; 
   30 ACCEPT BEEP VALIDATE ( UALPHA , DIGIT , "?!.*=" )  : A$ 
   35 INPUT "SEITE AUSGERICHTET?:"  : O$ 
   40 A = ASC ( SEG$ ( A$ , 1 , 1 ) ) 
   50 REM 
   60 REM 
   70 FOR T = 1 TO LEN ( A$ ) 
  ...
  933 DATA "6" , 193 , 289 , 305 , 297 , 293 , 291 , 194 
