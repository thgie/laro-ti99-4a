    1 GOTO 10 :: OPTION BASE 1  :: E , J , N , P , K1 , S$ , RD , S , S , SW , SP , HL , SCH , L , Y1 , Y2  :: DIM Q$ ( 4 ) , HH ( 7 ) , VV ( 4 ) , RR ( 4 ) , P$ ( 4 ) , LL ( 4 ) , V$ ( 4 ) , OO ( 5 ) , PP ( 5 ) , TT ( 5 ) 
    2 GOTO 10 :: DIM GG ( 4 ) , QQ ( 4 ) , ZZ ( 4 ) , XX ( 4 ) , YY ( 4 ) , AA ( 4 ) , BB ( 4 ) , CC ( 4 ) , DD ( 4 ) , EE ( 4 ) , FF ( 4 ) , II ( 4 ) , NN ( 67 ) , MM ( 68 ) 
   ...
   40 INPUT "ANZAHL SPIELER(1-4)?:"  : S  :: IF S < 1 OR S > 4 THEN 40
   60 SP = S  :: INPUT "SCHWIERIGKEITSGRAD(1-3)?:"  : SW  :: IF SW < 1 OR SW > 3 THEN 60
  ...
  246 IF RD = 6 OR ( RD = 8 AND SP > 2 ) THEN MM ( X ) = 4 
 ...
 4130 FOR X = 1 TO 10  :: FOR J = 1 TO 30 
 ...
 4200 ANGR = ANGR - 30 + X  :: IF ANGR > 0 THEN 4100
 ...
 8000 DISPLAY ERASE ALL  : "WAS WILL "  ; S$  ; " TUN?"  :  : "(1)  NICHTS" 
 ...
 8610 K6 = 1  :: GOTO 8305
 8645 K6 = 0 
 8650 FL = ( GG ( X ) > 0 ) * INT ( GG ( X ) / 3 * RND )  :: IF FL THEN PRINT  : P$ ( X )  ; " ZAHLT AN "  ; S$  ; FL  ; "G` F]R DEN ZAUBERFLUG"  ; "IN H\HLE"  ; QQ ( X )  ; "UND DEN HEILTRANK."  :: CALL P 
