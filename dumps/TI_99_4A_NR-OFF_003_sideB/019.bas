    5 CALL CLEAR 
    6 PRINT "ICH ZEICHNE JETZT:"  :  : 
    7 PRINT "-EINEN KREIS"  : "-EINE LINIE"  : "-EINEN BOGEN"  : "-EINE GERADE"  :  : "DRUECKEN SIE EINE TASTE" 
   13 CALL KEY ( 0 , K , S )  :: IF S < 1 THEN 13
  100 CALL CLEAR 
  110 CALL KREIS ( 0 , 0 , 20 ) 
  120 CALL LINIE ( 0 , 0 , 45 , 20 ) 
  130 CALL BOGEN ( 0 , 0 , 15 , 0 , 45 ) 
  140 CALL GERADE ( 30 , 0 , 0 , 30 ) 
  150 GOTO 150
20000 SUB LINIE ( Y , X , A , L ) 
20060 Q = A * PI / 180  :: V = SIN ( Q )  :: W = COS ( Q ) 
20140 FOR I = 1 TO L  :: CALL PLOT ( Y , X )  :: Y = Y + V  :: X = X + W  :: NEXT I 
20240 SUBEND 
