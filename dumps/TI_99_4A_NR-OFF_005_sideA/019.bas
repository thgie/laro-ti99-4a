  ...
  610 CALL CHAR ( 128 , "0103070F1F3F7FFF" , 129 , "FFFFFFFFFFFFFFFF" , 130 , "80C0E0F0F8FCFEFF" ) 
  615 CALL CHAR ( 136 , "30303FFFFF7E0C04" ) 
  620 CALL COLOR ( 12 , 16 , 6 , 2 , 6 , 6 , 13 , 12 , 6 , 14 , 7 , 1 , 11 , 13 , 1 ) 
  625 RETURN 
  635 CALL CLEAR 
  640 CALL SCREEN ( 12 ) 
  642 CALL HCHAR ( 1 , 1 , 42 , 256 ) 
  ...
  760 IF HELI_COUNT = HOW_MANY + 1 THEN CALL MOTION ( # 2 , 0 , 0 )  :: DISPLAY AT ( 12 , 5 ) SIZE ( 12 )  : "GUT GEMACHT!" ELSE 770
  ...
  900 IF SKLVL > 3 OR SKLVL < 1 THEN 895
  905 RETURN 
  915 CALL VERSION ( EB ) 
 ...
 1100 DISPLAY AT ( 12 , 5 ) SIZE ( 17 )  : "DU HAST VERLOREN!"  :: GOSUB 1000 :: FOR C = 1 TO 500  :: NEXT C 
 1105 GOSUB 1395
 1110 NEXT J 
 ...
 1315 IF MISS_COUNT = SKLVL + 1 THEN GOSUB 1335 :: DISPLAY AT ( 12 , 5 ) SIZE ( 17 )  : "DU HAST VERLOREN!" ELSE GOTO 1325
 1320 FOR I = 1 TO 500  :: NEXT I  :: GOSUB 1395
 1325 RETURN 
 ...
 1365 CALL SOUND ( - 1 , 40000 , 30 )  :: CALL MOTION ( # 1 , 0 , 20 )  :: FOR C = 1 TO 290  :: CALL POSITION ( # 1 , @ , PC )  :: IF PC > 250 THEN 1375
 1370 NEXT C 
 ...
 1450 GOSUB 1130 :: CALL CLEAR  :: CALL CHARSET  :: CALL SCREEN ( 8 ) 
 1455 GOSUB 535
 1460 GOSUB 915
 1465 GOSUB 815
 1470 GOSUB 860
 1475 GOSUB 935
 1480 GOSUB 635
 1485 GOSUB 1000 :: PSHOTS = 0 
 1490 GOSUB 740
 1495 IF TIME = 1 THEN GOSUB 1055 :: GOTO 1490
 1500 CALL BASE_MOVE ( TARGET$ ) 
 1505 CALL SHOT_CHECK ( SHOT_FLAG$ , TARGET$ ) 
 1510 IF SHOT_COUNT < SHOT_LIMIT THEN 1520
 1515 GOSUB 1335 :: DISPLAY AT ( 12 , 5 ) SIZE ( 17 )  : "DU HAST VERLOREN!"  :: FOR I = 1 TO 500  :: NEXT I  :: GOSUB 1000 :: GOSUB 1395
 1520 IF SHOT_FLAG$ = "ON" THEN CALL SHOT ( SHOT_FLAG$ , TARGET$ , NW_HELI$ , SHOT_COUNT , ILOOP )  :: IF TARGET$ = "PARA" THEN PSHOTS = PSHOTS + 1 
 1525 IF PSHOTS = SKLVL + 2 THEN CALL DELSPRITE ( # 1 )  :: TARGET$ = "HELI"  :: NW_HELI$ = "YES"  :: GOSUB 1305
