    ...
    7 DISPLAY AT ( 15 , 2 )  : "3-DIMENSIONALES LABYRINTH" 
    8 DISPLAY AT ( 24 , 6 )  : "** MOMENT BITTE **" 
    9  ! FOR VERZOEG=1 TO 1000 :: NEXT VERZOEG
  110 RANDOMIZE 
 ...
 1110 RESTORE 1390
 1120 CALL CHAR ( 58 , "FFFFFFFFFFFFFFFF" ) 
 1130 FOR K = 1 TO 10 
 1140 READ A$ 
 1150 FOR I = 1 TO 3 
 1160 READ J 
 ...
 1490 U ( XI , YI ) = F ( X - 1 + X1 , Y - 3 + YI ) 
 1500 NEXT YI 
 1510 NEXT XI 
 1520 RETURN 
 1530 FOR XI = 0 TO 2 
 1540 FOR YI = 0 TO 2 
 1550 IF X + 3 - Y1 > 23 THEN 1570
 ...
 1820 IF U ( 1 , 1 ) < 0 THEN 1970
 1830 IF U ( 1 , 1 ) > 0 THEN 1960
 1840 CALL COLOR ( 7 , 16 , 1 ) 
 1850 IF U ( 0 , 1 ) > O THEN 1870
 1860 CALL COLOR ( 8 , 16 , 1 ) 
 1870 IF U ( 2 , 1 ) > O THEN 1890
 1880 CALL COLOR ( 9 , 16 , 1 ) 
 1890 IF U ( 1 , 0 ) < 0 THEN 1970
