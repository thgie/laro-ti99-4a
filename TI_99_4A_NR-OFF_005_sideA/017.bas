  ...
  225 POI = POI + 1 / 3  :: IF INT ( POI ) = POI1 THEN 180
  227 POI1 = INT ( POI ) 
  ...
  280 IF POI > LEN ( M$ ( 1 ) ) - 13 THEN POI = 1  :: GOTO 180
  300 GOSUB 13000
  310 GOTO 180
 1990  !  CRASH
 ...
 2030 CALL MAGNIFY ( 2 ) 
 2032 FOR I = 1 TO 100  :: CALL KEY ( 0 , K , S ) 
 2033 IF K = 76 OR K = 108 THEN GOSUB 14200 :: GOTO 2036
 2034 NEXT I 
...
12110 NEXT Q 
12115 IF LEN ( M$ ( 1 ) ) < = 200 THEN 12080
12120 FOR I = 1 TO 3  :: M$ ( I ) = M$ ( I ) & Z$ ( I , 18 ) & Z$ ( I , 15 )  :: NEXT I 
12130 RETURN 
