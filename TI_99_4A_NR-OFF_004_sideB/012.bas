  ...
  410 B , BO = 20 
  412 A1 = 4  :: B1 = 3 
  415 CALL SPRITE ( # 1 , 112 , 16 , A1 * 8 - 7 , A1 * 8 - 7 , # 2 , 112 , 16 , 160 , 200 ) 
  ...
  550 CALL POSITION ( # 1 , P , Q , # 2 , P1 , Q1 ) 
  555 CALL COINC ( # 1 , A * 8 - 7 , B * 8 - 7 , 8 , O )  :: CALL COINC ( # 2 , A * 8 - 7 , B * 8 - 7 , 8 , O1 )  :: IF O OR O1 THEN 10000
